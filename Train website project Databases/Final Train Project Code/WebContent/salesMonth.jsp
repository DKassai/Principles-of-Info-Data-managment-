...
<html>
    ...
    <body>
    <form action="monthSales.jsp" method="post">
    	<label for = "date"> Choose Year and Month:</label>
		<input name = "date" type="text" required placeholder= "YYYY-MM" size=8 maxlength="7">
