...
<html>
    ...
    <body>
    <form action="infoTrains.jsp" method="post">
    	<label for = "transitLine"> Choose Transit Line:</label>
		<input name = "transitLine" type="text" required placeholder= "ex: 'Highway to Hell 2'" size=30 maxlength="30">
